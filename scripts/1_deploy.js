async function main() {
  ...
  await token1.deploymentTransaction().wait(1); // wait to receive
  ...
  await token2.deploymentTransaction().wait(1); // wait to receive
  ...
  await token3.deploymentTransaction().wait(1); // wait to receive
  ...
  await exchange.deploymentTransaction().wait(1); // wait to receive
